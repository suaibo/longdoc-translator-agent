...
citations, author names, or duplicates. The suggested translation must be Chinese."""

TRANSLATION_SYSTEM = """You are a careful academic translator.
Translate the supplied document chunk into Chinese while preserving structure.
Rules:
...
chunk. Return concise Chinese notes covering entities, claims, terminology,
and unresolved references. Do not exceed 180 Chinese characters."""

QUALITY_SYSTEM = """Compare the source and Chinese translation.
